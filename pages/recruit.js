  ...
  return (
    <Layout>
      <div className={Style.description}>
        <h2>採用情報</h2>
        <p>
          学生さん、フリーターの方や、主婦の方や、お仕事帰りのWワークにも最適で、空いた時間を使って効率よく高収入を稼げます。
          心温まる癒し処…。そんなお店を一緒に作りましょう♪
        </p>
        <p>
          お仕事内容は耳かきとハンドリフレが主になり、NO風俗店で資格必要なし、誰にでも覚えられる簡単なお仕事です。人と接するのが好きな方、お話し好きな方、世話好きな方、耳かきが好きな方、どれか一つでも当てはまればOKです。
        </p>
        <p>
          まずはご応募いただき、面接時に仕事内容、待遇面について一通りの説明をします。
          その後ベテランの優しい女性指導者から、講習を経て実務にあたって頂きます。
        </p>
      </div>
